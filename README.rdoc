...
In your controller you can save your "location" by using method : 
     
     store_current_path( path = nil )
  
if you do not specify a path or url backtracker takes the current one automatically.
If you're using CanCan gem ( for example ) you can rescue application from an access denied error like this:
